...
<%@page import="com.boki.hibernate.bean.Cat"%>
<html>
<head>
...
${ param.action == 'initAdd' ? '新增 Cat 資料' : '修改 Cat 資料' } &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ <a href="catServlet?action=initAdd">新增 Cat</a> ][ <a href="catServlet?action=list">Cat 列表</a> ]
